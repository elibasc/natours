...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  //2- Verification token- si alguien modificó o si expiró el token
  //promisificamos el jwt para seguir trabajado con async/await
...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    //roles is an array [ 'admin', 'lead-guide' ] x ejemplo
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //2- Set new password if token has not expired and if there's an user
  if (!user) {
